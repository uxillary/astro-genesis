const ExclusionMap = () => {
  return (
    <div className="relative overflow-hidden rounded-[28px] border border-[#d6e3e0]/10 bg-[#0b0d0f]/80 shadow-panel">
        ...
        <svg className="h-full w-full" viewBox="0 0 640 320" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="bg-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <stop offset="40%" stopColor="#111821" />
            ...
            <pattern id="grid" width="20" height="20" patternUnits="userSpaceOnUse">
              <path d="M20 0H0V20" fill="none" stroke="rgba(214,227,224,0.08)" strokeWidth="1" />
            </pattern>
            <pattern id="hatch" patternUnits="userSpaceOnUse" width="8" height="8">
              <path d="M0 8L8 0" stroke="rgba(255,59,59,0.6)" strokeWidth="1" />
            </pattern>
            <filter id="glow">
          ...
          <g filter="url(#glow)" opacity="0.35">
            <ellipse cx="180" cy="120" rx="90" ry="40" fill="#ff3b3b" />
            <ellipse cx="440" cy="220" rx="120" ry="54" fill="#00b3ff" />
          </g>
          ...
          <polygon
            points="140,40 320,60 460,160 420,260 240,300 120,220"
            fill="none"
            stroke="rgba(0,179,255,0.6)"
            strokeDasharray="6 4"
          />
          <g fill="rgba(214,227,224,0.08)" stroke="rgba(214,227,224,0.14)" strokeWidth="0.5">
      ...
      <div className="absolute inset-0 border border-dashed border-[#d6e3e0]/10" />
      <footer className="absolute bottom-0 left-0 right-0 bg-[#0b0d0f]/70 px-6 py-4 font-mono text-[0.58rem] uppercase tracking-[0.32em] text-dim">
